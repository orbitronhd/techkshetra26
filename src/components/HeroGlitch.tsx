...
export function HeroGlitch(): React.JSX.Element {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Trigger threshold (e.g., 50px of scrolling)
      const threshold = 50
  ...
  useEffect(() => {
    ...
    const duration = 600 // ms duration for glitch transition
  ...
  // Calculate intensity of glitch (peaks at progress = 0.5)
